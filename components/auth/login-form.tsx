      ...
      <Card className="relative w-full max-w-md bg-card border-border">
        <CardHeader className="space-y-4 text-center">
          ...
          <CardDescription className="text-muted-foreground">
            Sign in to access your ProtectMe dashboard
          </CardDescription>
        </CardHeader>
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-sm text-emergency hover:underline">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-4 h-4 rounded border-border bg-secondary accent-emergency"
              />
          ...
          <CardFooter className="flex flex-col gap-4">
            ...
            <p className="text-sm text-muted-foreground text-center">
              ...
              <Link href="/signup" className="text-emergency hover:underline">
                Sign up
              </Link>
            </p>
          </CardFooter>
